...
from autogen_core import AgentId, AgentRuntime, BaseAgent, CancellationToken, FunctionCall
        ...
        for result in results:
            ...
            if isinstance(result, FunctionExecutionResult):
                ...
                function_results.append(
                    FunctionExecutionResult(content=f"Error: {result}", call_id=result.call_id, is_error=True, name="error")
                )
